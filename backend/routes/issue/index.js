...
router.post('/issue/:issueId/milestone/:milestoneId', service.addIssueMilestone);
// patch
...
router.delete('/issue/:issueId/milestone/:milestoneId', service.deleteIssueMilestone);
